...
class BookDetile extends StatelessWidget {
  static String name = 'Bookdetail';

  final BookdataModel bookdataModel;

  const BookDetile({Key? key, required this.bookdataModel}) : super(key: key);
